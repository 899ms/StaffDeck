...
export const SECTION_CARD_TITLE_CLASS = 'text-[14px] font-medium text-[#18181a] dark:text-white';
export const RETURN_BUTTON_CLASS =
  'h-8 gap-1 rounded-[10px] border-[0.5px] border-[#e3e7f1] bg-white px-5 text-[12px] font-normal text-[#757f9c] hover:border-[#cbd3e6]! hover:bg-white! hover:text-[#18181a]! focus-visible:border-[#cbd3e6]! focus-visible:ring-0 aria-expanded:border-[#cbd3e6]! aria-expanded:bg-white! aria-expanded:text-[#18181a]! data-[state=open]:border-[#cbd3e6]! data-[state=open]:bg-white! data-[state=open]:text-[#18181a]! dark:border-border dark:bg-(--surface) dark:text-muted-foreground dark:hover:bg-(--surface)! dark:aria-expanded:bg-(--surface)! dark:data-[state=open]:bg-(--surface)!';
...
export const CHAT_CARD_DRAGGING_CLASS = 'ring-1 ring-[#18181a]/15 dark:ring-white/20';
...
export const CHAT_UPLOAD_DROP_HINT_CLASS =
  'pointer-events-none absolute inset-0 z-[2] grid place-items-center rounded-[12px] border border-dashed border-[#d1d5db] bg-white/88 text-[14px] font-medium text-[#18181a] backdrop-blur-sm dark:border-white/20 dark:bg-[#26272d]/88 dark:text-white';
export const CHAT_MESSAGES_CLASS =
  'min-h-0 min-w-0 flex-1 overflow-auto bg-[#fbfcfd] px-[20px] py-[18px] dark:bg-[#1a1a1d]';
export const CHAT_COMPOSER_SHELL_CLASS =
  'shrink-0 border-t border-[#eceef1] pt-[16px] dark:border-white/10';
export const CHAT_COMPOSER_CLASS = 'grid gap-[12px]';
export const CHAT_TEXTAREA_CLASS =
  'min-h-[96px] resize-none rounded-[10px] border-[0.5px] border-[#e3e7f1] bg-[#fafafa] px-[14px] py-[12px] text-[13px] leading-[1.65] text-[#18181a] shadow-none placeholder:text-[#c0c6d4] focus-visible:border-[#18181a] focus-visible:ring-0 dark:border-white/10 dark:bg-[#1e1e1e] dark:text-white dark:placeholder:text-muted-foreground dark:focus-visible:border-white/40';
...
export const CHAT_BUBBLE_BASE_CLASS =
  'relative box-border max-w-[min(720px,92%)] min-w-0 rounded-[12px] border border-[#eceef1] bg-white px-[14px] py-[12px] text-[13px] leading-[1.65] whitespace-pre-wrap wrap-anywhere text-[#18181a] dark:border-white/10 dark:bg-[#26272d] dark:text-white';
export const CHAT_BUBBLE_ASSISTANT_CLASS = 'border-transparent bg-white shadow-none dark:bg-[#26272d]';
export const CHAT_BUBBLE_USER_CLASS =
  'max-w-[min(620px,80%)] rounded-[16px] border-transparent bg-[#f0eee9] shadow-none dark:bg-[#34332f]';
...
export const CHAT_BUBBLE_USER_EDITING_CLASS =
  'min-w-[min(360px,72vw)] max-w-[84%] rounded-[16px] border-transparent bg-[#f0eee9] px-[14px] py-[12px] dark:bg-[#34332f]';
...
export const CHAT_CONTENT_USER_ATTACHMENTS_CLASS =
  'max-w-full rounded-[18px] bg-[#f0eee9] px-[15px] py-[13px] dark:bg-[#34332f]';

export const CHAT_THINKING_BLOCK_CLASS = 'mb-[10px] min-w-0 max-w-full';
export const CHAT_THINKING_BUTTON_CLASS =
  'inline-flex cursor-pointer items-center gap-[7px] border-0 bg-transparent p-0 text-[13px] font-semibold leading-[1.5] text-[#62625e] hover:text-[#18181a] dark:text-muted-foreground dark:hover:text-white';
export const CHAT_THINKING_DETAILS_CLASS =
  'mb-[4px] mt-[10px] box-border grid max-w-full min-w-0 gap-[6px] rounded-[10px] border border-[#eceef1] bg-[#fafafa] p-[10px_12px] text-[12px] leading-[1.55] text-[#858b9c] dark:border-white/10 dark:bg-[#1e1e1e]';
...
export const CHAT_ATTACHMENT_CLASS =
  'grid min-h-[46px] w-[min(260px,100%)] grid-cols-[32px_minmax(0,1fr)] items-center gap-[9px] rounded-[8px] border border-[#eceef1] bg-[#fbfaf8] px-[7px_10px_7px_7px] text-[#18181a] shadow-[0_5px_14px_rgba(45,39,30,0.035)] dark:border-white/10 dark:bg-[#2a2a2e] dark:text-white';
export const CHAT_ATTACHMENT_USER_CLASS = 'ml-auto bg-[#f8f7f3] dark:bg-[#34332f]';
...
export const CHAT_ATTACHMENT_TYPE_CLASS = 'text-[11px] leading-[1.2] text-[#858b9c] dark:text-muted-foreground';

export const CHAT_EDIT_PANEL_CLASS = 'grid gap-[10px]';
export const CHAT_EDIT_PANEL_USER_ATTACHMENTS_CLASS =
  'w-[min(520px,100%)] rounded-[16px] bg-[#f0eee9] px-[14px] py-[12px] dark:bg-[#34332f]';
export const CHAT_EDIT_TEXTAREA_CLASS =
  'min-h-[34px] resize-none border-0 bg-transparent p-0 text-[16px] leading-[1.65] text-[#18181a] shadow-none focus-visible:ring-0 dark:text-white';
export const CHAT_EDIT_ACTIONS_CLASS = 'flex justify-end gap-[7px]';

export const CHAT_HOVER_ACTIONS_CLASS =
  'absolute right-[10px] bottom-[-26px] inline-flex items-center gap-[9px] text-[#858b9c] opacity-0 transition-opacity duration-150 group-hover/bubble:opacity-100 group-focus-within/bubble:opacity-100 dark:text-muted-foreground';
export const CHAT_TIME_CLASS = 'text-[12px] leading-none text-[#858b9c] dark:text-muted-foreground';
export const CHAT_HOVER_BUTTON_CLASS =
  'inline-flex size-[17px] items-center justify-center border-0 bg-transparent p-0 text-[#858b9c] hover:text-[#18181a] disabled:cursor-not-allowed disabled:opacity-45 dark:hover:text-white';
...
export const CHAT_DECISION_CLASS = 'mt-[10px] text-[12px] text-[#858b9c] dark:text-muted-foreground';

// Upload list
export const UPLOAD_LIST_CLASS = 'grid gap-[8px]';
export const UPLOAD_ITEM_BASE_CLASS =
  'grid min-h-[34px] min-w-0 grid-cols-[auto_minmax(0,1fr)_auto_auto] items-center gap-[8px] rounded-[10px] border border-[#eceef1] bg-[#fafafa] p-[6px_8px] text-[12px] text-[#18181a] dark:border-white/10 dark:bg-[#1e1e1e] dark:text-white';
export const UPLOAD_ITEM_ERROR_CLASS = 'border-[#fecaca] bg-[#fef2f2] text-[#d20b0b]';
export const UPLOAD_NAME_CLASS = 'min-w-0 truncate';
export const UPLOAD_STATUS_CLASS = 'whitespace-nowrap text-[#858b9c] dark:text-muted-foreground';

// Tool suggestions
export const TOOL_SUGGESTIONS_CLASS = 'mt-[12px] grid w-full min-w-0 max-w-full gap-[8px]';
export const TOOL_SUGGESTION_CLASS =
  'relative box-border max-w-full min-w-0 rounded-[10px] border border-[#eceef1] bg-[#fffdf9] px-[12px] py-[11px] shadow-[0_6px_16px_rgba(45,39,30,0.026)] dark:border-white/10 dark:bg-[#2a2824]';
...
export const TOOL_SUGGESTION_TITLE_CLASS =
  'min-w-0 truncate text-[13px] font-semibold text-[#18181a] dark:text-white';
export const TOOL_SUGGESTION_DESC_CLASS =
  'min-w-0 text-[12px] leading-[1.55] wrap-anywhere text-[#858b9c] dark:text-muted-foreground';
export const TOOL_SUGGESTION_META_CLASS =
  'mt-[7px] flex min-w-0 max-w-full items-center gap-[6px] text-[11px] text-[#858b9c] dark:text-muted-foreground';
export const TOOL_METHOD_CLASS =
  'min-w-[44px] shrink-0 rounded-full border border-[#eceef1] bg-white px-[7px] py-px text-center text-[11px] font-semibold text-[#18181a] dark:border-white/10 dark:bg-[#26272d] dark:text-white';
...
export const TOOL_ACTION_GROUP_CLASS =
  'inline-flex items-center justify-center gap-[4px] rounded-full border border-[#e2dacd]/90 bg-white/78 p-[2px] shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] dark:border-white/10 dark:bg-[#26272d]/78';
export const TOOL_ACTION_GROUP_DETAIL_CLASS = 'size-[32px]';
export const TOOL_ACTION_BUTTON_CLASS =
  'size-[26px] min-w-[26px] rounded-full p-0 text-[#858b9c] hover:bg-[#f3f1eb] hover:text-[#18181a] dark:hover:bg-white/10 dark:hover:text-white';
...
const TOOL_STATUS_BADGE_VARIANTS: Record<ToolStatusBadgeVariant, string> = {
  ...
  muted: 'text-[#858b9c] bg-[#f7f5ef] border-[#eceef1] dark:text-muted-foreground dark:bg-white/10 dark:border-white/10',
};
...
export const REWRITE_MODEL_BUTTON_CLASS =
  'inline-flex h-8 max-w-[220px] min-w-0 items-center gap-2 rounded-[10px] border-[0.5px] border-[#e3e7f1] bg-white px-[12px] text-[12px] font-normal text-[#757f9c] shadow-none hover:border-[#cbd3e6]! hover:bg-white! hover:text-[#18181a]! focus-visible:border-[#cbd3e6]! focus-visible:ring-0 aria-expanded:border-[#cbd3e6]! aria-expanded:bg-white! aria-expanded:text-[#18181a]! data-[state=open]:border-[#cbd3e6]! data-[state=open]:bg-white! data-[state=open]:text-[#18181a]! dark:border-white/10 dark:bg-[#26272d] dark:text-muted-foreground dark:hover:bg-[#26272d]! dark:hover:text-white dark:aria-expanded:bg-[#26272d]! dark:aria-expanded:text-white dark:data-[state=open]:bg-[#26272d]! dark:data-[state=open]:text-white [&>span:first-child]:min-w-0 [&>span:first-child]:truncate';

// Source toolbar + editor
export const SOURCE_TOOLBAR_CLASS =
  'mb-[12px] flex shrink-0 flex-wrap items-center gap-[8px] rounded-[10px] bg-[#fafafa] p-[8px] dark:bg-[#1e1e1e]';
export const SOURCE_EMPTY_STATE_CLASS =
  'flex min-h-[240px] flex-1 flex-col items-center justify-center gap-[10px] rounded-[12px] border border-dashed border-[#e3e7f1] bg-[#fbfcfd] px-[24px] py-[32px] text-center dark:border-white/10 dark:bg-[#1a1a1d]';
export const SOURCE_EMPTY_TEXT_CLASS = 'text-[13px] leading-[20px] text-[#858b9c] dark:text-muted-foreground';
...
export const SOURCE_GROUP_TITLE_CLASS =
  'my-[2px_-2px] text-[13px] font-semibold text-[#18181a] dark:text-white';
...
export const SOURCE_SECTION_CLASS =
  'relative box-border w-full cursor-pointer rounded-[10px] border border-[#eceef1] bg-white p-[16px] text-left select-text hover:border-[#04756f] hover:shadow-[0_8px_22px_rgba(4,117,111,0.08)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#18181a] dark:border-white/10 dark:bg-[#26272d] dark:hover:border-[#04756f]';
export const SOURCE_SECTION_ACTIVE_CLASS = 'border-[#04756f] bg-[#f3fbf8] shadow-[0_8px_22px_rgba(4,117,111,0.08)] dark:bg-[#1a2e2a]';
export const SOURCE_SECTION_CHANGED_CLASS =
  'border-[#04756f] bg-[#effaf6] shadow-[0_12px_30px_rgba(4,117,111,0.12)] transition-[background,border-color,box-shadow] duration-450 dark:bg-[#1a2e2a]';
export const SOURCE_SECTION_DIRTY_CLASS = 'bg-[#fffdf8] shadow-[inset_3px_0_0_#d8c7a4] dark:bg-[#2a2824]';
export const SOURCE_SECTION_UPDATING_CLASS = 'animate-pulse';

export const SOURCE_RENDERED_CLASS = 'grid gap-[12px] text-[13px] leading-[1.7] text-[#18181a] dark:text-white';
...
export const SOURCE_KEY_CLASS = 'text-[12px] font-semibold text-[#858b9c] dark:text-muted-foreground';
export const SOURCE_VALUE_CLASS = 'min-w-0 w-full whitespace-pre-wrap text-[#18181a] dark:text-white';
export const SOURCE_READONLY_VALUE_CLASS = 'block';
export const SOURCE_JSON_INLINE_CLASS =
  'm-0 max-w-full rounded-[8px] border border-[#eceef1] bg-[#f8f6ef]/72 p-[8px_10px] whitespace-pre-wrap wrap-anywhere text-[#18181a] dark:border-white/10 dark:bg-[#1e1e1e] dark:text-white';
export const SOURCE_EDIT_FIELD_CLASS = 'flex min-w-0 w-fit max-w-full items-start';

const PILL_OUTLINE_BUTTON_BASE =
  'inline-flex cursor-pointer items-center justify-center gap-1 rounded-full border-[0.5px] border-[#e3e7f1] bg-white text-[12px] font-normal leading-none text-[#858b9c] shadow-none transition-colors hover:border-[#04756f]! hover:bg-white! hover:text-[#18181a]! focus-visible:border-[#04756f]! focus-visible:ring-0 focus-visible:outline-none focus-visible:text-[#18181a]! dark:border-white/10 dark:bg-[#26272d] dark:text-muted-foreground dark:hover:border-[#04756f]! dark:hover:bg-[#26272d]! dark:hover:text-white [&_.anticon]:inline-flex [&_.anticon]:shrink-0 [&_.anticon]:items-center [&_.anticon]:justify-center [&_.anticon_svg]:block';
...
export const SOURCE_TITLE_INPUT_CLASS =
  'max-w-full rounded-[6px] border-transparent bg-transparent px-[6px] py-0 text-[18px] font-semibold leading-[1.5] shadow-none hover:border-[#eceef1] hover:bg-white focus-visible:border-[#eceef1] focus-visible:bg-white focus-visible:ring-0 dark:hover:border-white/10 dark:hover:bg-[#26272d] dark:focus-visible:bg-[#26272d]';
export const SOURCE_STEP_TITLE_EDIT_CLASS =
  'inline-grid max-w-full min-w-0 grid-cols-[auto_auto] items-center gap-[6px] text-[15px] font-semibold [&>span:first-child]:whitespace-nowrap [&>span:first-child]:text-[#18181a] dark:[&>span:first-child]:text-white';
export const SOURCE_EDIT_INPUT_CLASS =
  'max-w-full resize-none overflow-y-hidden! rounded-[6px] border-transparent bg-transparent px-[6px] py-[2px] leading-[1.65] shadow-none hover:border-[#eceef1] hover:bg-white focus-visible:border-[#eceef1] focus-visible:bg-white focus-visible:ring-0 dark:hover:border-white/10 dark:hover:bg-[#26272d] dark:focus-visible:bg-[#26272d]';

export const SOURCE_COLLAPSIBLE_EDITOR_CLASS = 'grid w-[min(960px,100%)] gap-[8px]';
export const SOURCE_COLLAPSIBLE_HEAD_CLASS =
  'grid min-h-[38px] w-full cursor-pointer grid-cols-[minmax(0,1fr)_auto] items-center gap-[10px] rounded-[10px] border border-[#eceef1] bg-linear-to-b from-[#f8f7f4]/96 to-[#f4f2ed]/78 px-[12px] py-[6px] text-left text-[#858b9c] shadow-[inset_0_1px_0_rgba(255,255,255,0.74)] hover:border-[#d1d5db] hover:bg-white hover:text-[#18181a] focus-visible:outline-none dark:border-white/10 dark:from-[#26272d] dark:to-[#1e1e1e] dark:hover:bg-[#26272d] dark:hover:text-white';
export const SOURCE_COLLAPSIBLE_PREVIEW_CLASS = 'min-w-0 truncate text-[12px] leading-[1.5]';
export const SOURCE_COLLAPSIBLE_PREVIEW_MUTED_CLASS = 'text-[#858b9c] dark:text-muted-foreground';
export const SOURCE_COLLAPSIBLE_TOGGLE_CLASS =
  'inline-flex h-[26px] shrink-0 items-center gap-[5px] rounded-full border border-[#eceef1] bg-white px-[9px] text-[12px] font-semibold leading-none text-[#858b9c] dark:border-white/10 dark:bg-[#26272d]';
...
export const SOURCE_ACTION_REMOVE_CLASS =
  'grid size-[16px] scale-[0.86] place-items-center rounded-full border-0 bg-transparent p-0 text-[#858b9c] opacity-0 transition-[opacity,transform,color,background] duration-140 group/token:pointer-events-auto group/token:scale-100 group/token:opacity-100 hover:bg-[#f2f3f5] hover:text-[#18181a] dark:hover:bg-white/10';
...
export const SOURCE_ACTION_SELECT_CLASS =
  'h-[26px] max-w-full rounded-full border border-[#eceef1] bg-white px-2 text-[12px] leading-[1.4] shadow-none dark:border-white/10 dark:bg-[#26272d]';
export const SOURCE_EDIT_HINT_CLASS =
  'shrink-0 text-[11px] text-[#858b9c] opacity-0 group/action-editor:opacity-100 dark:text-muted-foreground';
...
export const CONDITION_READABLE_CLASS =
  'col-span-full text-[12px] leading-[1.55] text-[#858b9c] dark:text-muted-foreground';
...
export const RETRY_POLICY_FIELD_CLASS = 'grid min-w-0 gap-[4px] [&>span]:text-[11px] [&>span]:font-semibold [&>span]:leading-[1.3] [&>span]:text-[#858b9c] dark:[&>span]:text-muted-foreground';

export const FLOW_RULE_EDITOR_CLASS = 'grid w-[min(1120px,100%)] gap-[10px]';
export const FLOW_RULE_HEAD_CLASS =
  'flex flex-wrap items-center justify-between gap-2 text-[12px] font-semibold text-[#858b9c] dark:text-muted-foreground';
export const FLOW_RULE_LIST_CLASS = 'grid gap-[10px]';
export const FLOW_RULE_ITEM_CLASS =
  'grid min-w-0 gap-x-[12px] gap-y-[10px] rounded-[12px] border border-[#eceef1] bg-[#fafafa] p-[12px] [grid-template-areas:"target_label_priority_delete"_"condition_condition_condition_condition"] [grid-template-columns:minmax(220px,1.05fr)_minmax(220px,1fr)_112px_32px] dark:border-white/10 dark:bg-[#1e1e1e]';
export const FLOW_RULE_FIELD_CLASS = 'grid min-w-0 gap-[4px] [&>span]:text-[11px] [&>span]:font-semibold [&>span]:leading-[1.3] [&>span]:text-[#858b9c] dark:[&>span]:text-muted-foreground';
export const FLOW_RULE_FIELD_TARGET_CLASS = '[grid-area:target]';
export const FLOW_RULE_FIELD_LABEL_CLASS = '[grid-area:label]';
export const FLOW_RULE_FIELD_CONDITION_CLASS = '[grid-area:condition] [&_em]:text-[11px] [&_em]:not-italic [&_em]:leading-[1.45] [&_em]:text-[#858b9c] dark:[&_em]:text-muted-foreground';
...
export const FLOW_RULE_EMPTY_CLASS =
  'rounded-[12px] border border-dashed border-[#eceef1] bg-[#fafafa] p-[10px_12px] text-[12px] text-[#858b9c] dark:border-white/10 dark:bg-[#1e1e1e] dark:text-muted-foreground';

export const NODE_DELETE_CONFIRM_CLASS = 'grid gap-[8px] [&_p]:m-0 [&_ul]:m-0 [&_ul]:pl-[18px]';

// Flow diagram
export const FLOW_ZOOM_TOOLBAR_CLASS =
  '-mt-[2px] mb-[12px] flex min-h-[40px] items-center gap-[8px] text-[12px] text-[#858b9c] dark:text-muted-foreground';

const FLOW_ZOOM_BUTTON_BASE =
  'inline-flex shrink-0 items-center justify-center rounded-[9px] border-[0.5px] border-[#e3e7f1] bg-white text-[12px] font-normal leading-none text-[#757f9c] shadow-none transition-colors hover:border-[#cbd3e6]! hover:bg-white! hover:text-[#18181a]! focus-visible:border-[#cbd3e6]! focus-visible:ring-0 focus-visible:outline-none aria-pressed:border-[#04756f]! aria-pressed:bg-[#f3fbf8]! aria-pressed:font-medium aria-pressed:text-[#18181a]! dark:border-white/10 dark:bg-[#26272d] dark:text-muted-foreground dark:hover:border-white/20! dark:hover:bg-[#26272d]! dark:hover:text-white dark:aria-pressed:border-[#04756f]! dark:aria-pressed:bg-[#1a2e2a]! dark:aria-pressed:text-white';
...
export function flowZoomPresetButtonClass(active: boolean): string {
  return cn(
    ...
    active && 'border-[#04756f]! bg-[#f3fbf8]! font-medium text-[#18181a]! dark:bg-[#1a2e2a]! dark:text-white',
  );
}

export const FLOW_ZOOM_VALUE_CLASS =
  'inline-flex h-7 min-w-[42px] items-center justify-center rounded-[9px] bg-[#fafafa] px-2 text-center font-mono text-[12px] leading-none text-[#18181a] dark:bg-[#1e1e1e] dark:text-white';
...
export const FLOW_NODE_CLASS =
  'relative isolate box-border grid h-full min-h-0 w-full cursor-pointer grid-rows-[auto_auto_auto_auto_minmax(0,1fr)] gap-[7px] overflow-hidden rounded-[10px] border border-[#eceef1] bg-[#fffefd] p-[14px_15px] text-left select-text text-[#18181a] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#18181a] dark:border-white/10 dark:bg-[#26272d] dark:text-white';
export const FLOW_NODE_ROOT_CLASS =
  'relative z-[1] h-full min-h-0 w-full justify-self-start bg-[#f2f0eb] shadow-[0_14px_34px_rgba(37,32,24,0.08)] dark:bg-[#34332f]';
...
export const FLOW_NODE_CHANGED_CLASS =
  'border-[#04756f] bg-[#effaf6] shadow-[0_12px_30px_rgba(4,117,111,0.12)] transition-[background,border-color,box-shadow] duration-450 dark:bg-[#1a2e2a]';
export const FLOW_NODE_DIRTY_CLASS = 'bg-[#fffdf8] shadow-[inset_3px_0_0_#d8c7a4] dark:bg-[#2a2824]';
...
export const FLOW_NODE_SUMMARY_CLASS =
  'm-[2px_0_0] line-clamp-3 text-[13px] leading-[1.5] wrap-anywhere text-[#858b9c]! dark:text-muted-foreground!';
...
export const FLOW_COMPACT_ROW_CLASS =
  'grid min-w-0 grid-cols-[34px_minmax(0,1fr)] items-start gap-[8px] [&>span:first-child]:text-[12px] [&>span:first-child]:font-semibold [&>span:first-child]:leading-[24px] [&>span:first-child]:text-[#858b9c] dark:[&>span:first-child]:text-muted-foreground';
export const FLOW_ROUTE_COUNT_CLASS =
  'w-fit rounded-full border border-dashed border-[#eceef1] bg-[#fafafa] px-2 py-[3px] text-[11px] leading-[1.3] text-[#858b9c] dark:border-white/10 dark:bg-[#1e1e1e] dark:text-muted-foreground';
export const FLOW_META_CLASS = 'mt-[6px] grid gap-[8px]';
export const FLOW_META_ROW_CLASS = 'grid gap-[5px]';
export const FLOW_META_LABEL_CLASS = 'text-[11px] font-semibold text-[#858b9c] dark:text-muted-foreground';
export const FLOW_CHIP_LIST_CLASS = 'flex max-h-[54px] flex-wrap gap-[6px] overflow-hidden';
export const FLOW_CHIP_CLASS =
  'max-w-full overflow-hidden rounded-full border border-[#eceef1] bg-[#fafafa] px-2 py-[4px] text-[11px] leading-[1.4] wrap-anywhere text-[#858b9c] dark:border-white/10 dark:bg-[#1e1e1e] dark:text-muted-foreground';
export const FLOW_CHIP_MUTED_CLASS = 'text-[#858b9c] dark:text-muted-foreground';
export const FLOW_CHIP_TERMINAL_CLASS = '';

// Action chips
export const ACTION_LIST_CLASS = 'flex max-h-[84px] flex-wrap gap-[6px] overflow-auto';
export const ACTION_EMPTY_CLASS = 'text-[#858b9c] dark:text-muted-foreground';
...
export const SAVE_REVIEW_FORM_LABEL_CLASS =
  'grid gap-[6px] text-[12px] text-[#858b9c] dark:text-muted-foreground';
export const SAVE_REVIEW_DIFF_CLASS = 'grid max-h-[420px] gap-[10px] overflow-auto';
export const SAVE_REVIEW_DIFF_ROW_CLASS =
  'rounded-[10px] border border-[#eceef1] bg-[#fafafa] p-[10px_12px] dark:border-white/10 dark:bg-[#1e1e1e]';
export const SAVE_REVIEW_DIFF_PATH_CLASS =
  'mb-[6px] text-[12px] font-semibold text-[#858b9c] dark:text-muted-foreground';
...
export const TOOL_SUGGESTION_DETAIL_PRE_CLASS =
  'm-0 max-h-[220px] overflow-auto rounded-[10px] border border-[#eceef1] bg-[#fafafa] p-[12px] text-[12px] dark:border-white/10 dark:bg-[#1e1e1e]';

// Inline editable source inputs (replaces ant-input)
export const SOURCE_INPUT_CLASS =
  'h-auto min-h-0 w-full rounded-[6px] border border-transparent bg-transparent px-[6px] py-[2px] text-[13px] leading-[1.65] text-[#18181a] shadow-none transition-colors hover:border-[#eceef1] hover:bg-white focus-visible:border-[#eceef1] focus-visible:bg-white focus-visible:ring-0 dark:text-white dark:hover:border-white/10 dark:hover:bg-[#26272d] dark:focus-visible:bg-[#26272d]';
